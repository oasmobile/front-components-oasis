...
class Footer {
    constructor(data) {
        ...
        this.billHref = data.billHref || `//www.oasgames.com/bill/Bill(JA).html`;
    ...
    forum() {
        ...
        if(this.billBok){
            this.billContent = `<span> | <a target="_blank" href="${this.billHref}">${this.langContent.footer_bill}</a></span>`;
        }else{
            this.billContent = '';
        }
    }
